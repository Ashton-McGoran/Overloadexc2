...
namespace Assignment9ex2Operatoroverloading
{
    public class Log
    {
        ...
        // Overloaded operator +
        public static Log operator +(Log log, double hoursToAdd)
        {
        ...
        // Overloaded operator -
        public static Log operator -(Log log, double hoursToSubtract)
        {
                ...
                switch (selection)
                {
                    ...
                    case 4:
                        ...
                        if (ans == "Y" || ans == "y")
                        {
                            ...
                            double hr;
                            while (!double.TryParse(Console.ReadLine(), out hr))
